...
function renderizarTabla() {
    //función que renderiza la tabla con los clientes
...
function guardarEnLocalStorage() {
    //función que guarda el estado actual de la aplicación
...
function cargarDesdeLocalStorage() {
    //función que carga el estado anterior de la aplicación
